...
def _build_change_relocated_layout(
    ...
    for intent in intents:
        ...
        # Nested path (dotted / indexed) -- covers BOTH the item-price paths
        # (price_list[N].price.price, GitHub #259) and the gear-stat paths
        ...
        # Both writers now share apply_nested_intent so they cannot drift.
